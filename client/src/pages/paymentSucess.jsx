...
const Success = () => {
  ...
  return (
    <div className="min-h-screen bg-green-50 py-10 px-4 flex flex-col items-center">
      ...
      <div className="bg-white shadow-lg rounded-lg p-10 max-w-md w-full text-center border border-green-400 mb-10">
      ...
      <div className="w-full max-w-5xl bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex flex-col items-center space-y-6 w-full lg:w-56">
            {profileImage && (
