import {
  require_jsx_runtime
} from "./chunk-37VD3AR6.js";
import {
  require_react
} from "./chunk-B2L2YAW2.js";
import {
  __toESM
} from "./chunk-5WWUZCGV.js";

// node_modules/.pnpm/react-country-region-select_2a5856b69a796eeb615ac21ffe9cb1c2/node_modules/react-country-region-selector/dist/rcrs.es.js
...
var t = ({ value: n2 = "", name: i2 = "rcrs-country", id: t2 = "", className: u2 = "", showDefaultOption: h2 = true, defaultOptionLabel: d2 = "Select Country", priorityOptions: S = [], onChange: A = () => null, onBlur: g = () => null, labelType: m = "full", valueType: B = "full", whitelist: M = l, blacklist: k = s, disabled: b = false, customRender: c = r, ...C }) => {
  const N = (0, import_react.useMemo)(() => {
    ...
    if (h2)
      return { value: "", key: "default", label: d2 };
...
var d = ({ onChange: n2, value: i2, country: o2 = "", onBlur: l2 = () => null, id: s2 = "", name: t2 = "rcrs-region", className: d2 = "", disabled: S = false, blankOptionLabel: A = "-", showDefaultOption: g = true, defaultOptionLabel: m = "Select Region", labelType: B = "full", valueType: M = "full", countryValueType: k = "full", disableWhenEmpty: b = false, customOptions: c = [], whitelist: C = u, blacklist: N = h, customRender: K = r, ...T }) => {
  const P = (0, import_react.useMemo)(() => {
    ...
    if (e.forEach((e2) => {
      ...
      return console.error("Error. Unknown country passed: " + o2 + `. If you're passing a country shortcode, be sure to include countryValueType="short" on the RegionDropdown`), [];
    const i3 = ((a3, n4, e2) => {
